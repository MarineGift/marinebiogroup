...
let db: any = null;
console.log("Using memory storage as primary (Supabase connection disabled due to driver compatibility)");
// TODO: Fix Supabase connection with proper postgres driver
/*
try {
