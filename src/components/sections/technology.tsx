export default function Technology() {
  return (
    <section id="technology" className="section" style={{ background: '#f9fafb' }}>
      <div className="container">
        <h2>Revolutionary Marine Nano-Fiber Technology</h2>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.5rem' }}>Advanced Extraction</h3>
                  <p style={{ color: '#6b7280' }}>Proprietary methods for harvesting nano-fibers while preserving marine ecosystems</p>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                <div className="marine-gradient" style={{ width: '48px', height: '48px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '1.25rem' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.5rem' }}>Precision Processing</h3>
                  <p style={{ color: '#6b7280' }}>State-of-the-art refinement techniques that enhance fiber properties</p>
                </div>
              </div>
            </div>
          </div>
          <div className="marine-gradient" style={{ borderRadius: '16px', padding: '2rem', color: 'white' }}>
            <div style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '8px', padding: '1.5rem', marginBottom: '1.5rem' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '1rem' }}>Technology Stats</h3>
